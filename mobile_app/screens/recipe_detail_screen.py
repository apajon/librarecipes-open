...
from src.crud.recettes import get_recette_by_id, delete_recette
...
class RecipeDetailScreen(MDScreen):
    ...
    def create_categories_section(self):
        ...
        # Categories chips
        if self.recipe.categories:
            categories_layout = MDGridLayout(
                cols=3,
                spacing=dp(8),
                adaptive_height=True,
                size_hint_y=None
    ...
    def create_info_section(self):
        ...
        # Date added
        date_added = self.recipe.date_ajout.strftime("%B %d, %Y") if self.recipe.date_ajout else "Unknown"
        date_label = MDLabel(
    ...
    def delete_recipe(self):
        ...
        try:
            ...
            if success:
                ...
                Snackbar(text=f"Recipe '{self.recipe.nom}' deleted").open()
