...
class SearchScreen(MDScreen):
    ...
    def create_search_form(self):
        ...
        self.ingredients_field = MDTextField(
            hint_text="Ingredients (comma separated)...",
            size_hint_y=None,
            height=dp(40)
        )
        ...
        self.any_ingredients_check = MDCheckbox(
            active=True,
            group="ingredients_mode",
            size_hint_x=None,
            width=dp(30)
        )
        ...
        self.all_ingredients_check = MDCheckbox(
            active=False,
            group="ingredients_mode",
            size_hint_x=None,
            width=dp(30)
