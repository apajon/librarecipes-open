package com.apajon.librarecipes.di
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideLibraRecipesApiService(retrofit: Retrofit): LibraRecipesApiService {
        return retrofit.create(LibraRecipesApiService::class.java)
    }
}